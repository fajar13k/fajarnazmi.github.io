			...
			<div className="w-full">
				<section id="bottom-navigation" className="lg:hidden md:block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
					<div id="tabs" className="flex justify-between">
						<Link to={env} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
						...
						<Link to={`${env}about`} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
						...
						<Link to={`${env}works`} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
							<svg width="25" height="25" viewBox="0 0 25 25" className="inline-block mb-1">
						...
						<Link to={`${env}contact`} className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
							<svg width="25" height="25" viewBox="0 0 25 25" className="inline-block mb-1">
